        ...
        <x-box :title="__('Change password')" class="mb-6" padding="p-0">
          <x-form method="put" action="{{ route('settings.password.update') }}">
            ...
            <div class="grid grid-cols-3 items-center rounded-t-lg border-b border-gray-200 p-3 hover:bg-blue-50">
              <p class="col-span-2 block text-sm font-medium dark:text-gray-300 text-gray-700">{{ __('Current password') }}</p>
            ...
            <div class="grid grid-cols-3 items-center border-b border-gray-200 p-3 hover:bg-blue-50">
              <p class="col-span-2 block text-sm font-medium dark:text-gray-300 text-gray-700">{{ __('New password') }}</p>
              <div class="w-full justify-self-end">
            ...
            <div class="grid grid-cols-3 items-center border-b border-gray-200 p-3 hover:bg-blue-50">
              <p class="col-span-2 block text-sm font-medium dark:text-gray-300 text-gray-700">{{ __('Confirm new password') }}</p>
              <div class="w-full justify-self-end">
