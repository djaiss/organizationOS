...
@else
  <button wire:loading.attr="disabled" {{ $attributes->merge(['type' => 'submit', 'class' => 'rounded-md border border-indigo-700 bg-indigo-500 px-3 py-1 font-semibold text-white shadow-sm hover:bg-indigo-700']) }}>
    {{ $slot }}
  </button>
@endif
