  ...
  <nav class="flex flex-1 items-center gap-3 pt-4 pb-2">
    ...
    <div class="flex items-center gap-1">
      ...
      <div x-data="{ menuOpen: false }" @click.away="menuOpen = false" class="relative">
        ...
        <div x-show="menuOpen" x-transition:enter="transition duration-100 ease-linear" x-transition:enter-start="-translate-y-1 opacity-90" x-transition:enter-end="translate-y-0 opacity-100" class="absolute top-0 right-0 z-50 mt-10 w-48 min-w-[8rem] rounded-md border border-gray-200/70 bg-white p-1 text-sm text-gray-800 shadow-md" x-cloak>
